...
class AppConstants {
  static const String appName = 'YETU';
  static const double appVersion = 2.2;

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;

  static const String baseUrl = 'https://brands.sanaa.co';


// soko
  static const String baseUrlsoko = 'https://soko.ug/api/v1/';
  static const String productUrisoko = 'https://soko.ug/api/v1/products/featured?page=3';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.arabic, languageName: 'French', countryCode: 'SA', languageCode: 'fr'),
